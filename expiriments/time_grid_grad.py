...
# GRID = 256
grid_list = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1024]
# grid_list = 128 * np.array(range(1, 9))
# grid_list = [128, 130, 250, 256, 500, 512, 768, 800]
# grid_list = [256]
...
for ppinv_name, ppinv in PPinv_dict.items():
    ...
    for GRID in grid_list:
        ...
        for t in tqdm(threshold_list):
            ...
            results.to_csv(f'{save_dir}/new_varygrid_grad_t0125_{date}.csv', index=False)
